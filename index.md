...
14       | 01.03.2024   | Estimación de Densidades por Kernel (KDE). <br/> | [1D-kernel-density.ipynb](code/1D-kernel-density.ipynb){:target="_blank"} [2D-kernel-density.ipynb](code/2D-kernel-density.ipynb){:target="_blank"} 
